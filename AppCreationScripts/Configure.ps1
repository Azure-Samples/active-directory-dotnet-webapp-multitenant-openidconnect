...
#> 
   ...
   Write-Host "Creating the AAD application (active-directory-dotnet-webapp-multitenant-openidconnect)"
   # Get a 2 years application key for the service Application
   $pw = ComputePassword
   $fromDate = [DateTime]::Now;
   $key = CreateAppKey -fromDate $fromDate -durationInYears 2 -pw $pw
   $serviceAppKey = $pw
   $serviceAadApplication = New-AzureADApplication -DisplayName "active-directory-dotnet-webapp-multitenant-openidconnect" `
                                                   -HomePage "https://localhost:44302/" `
                                                   -LogoutUrl "https://localhost:44322/Account/EndSession" `
                                                   -ReplyUrls "https://localhost:44302/" `
                                                   -IdentifierUris "https://$tenantName/active-directory-dotnet-webapp-multitenant-openidconnect" `
   ...
   Write-Host "Done creating the service application (active-directory-dotnet-webapp-multitenant-openidconnect)"
   ...
   Add-Content -Value "<tr><td>service</td><td>$currentAppId</td><td><a href='$servicePortalUrl'>active-directory-dotnet-webapp-multitenant-openidconnect</a></td></tr>" -Path createdApps.html
   ...
   $configFile = $pwd.Path + "\..\dotnet-webapp-multitenant-openidconnect\Web.Config"
